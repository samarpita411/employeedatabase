...
public class CreateEmployeeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		employeeInfoBean.setId(Integer.parseInt(req.getParameter("id")));
	    ...
	    employeePersonalInfoBean.setId(Integer.parseInt(req.getParameter("id")));
	    ...
	    employeeAddressInfoBean.setId(Integer.parseInt(req.getParameter("id")));
